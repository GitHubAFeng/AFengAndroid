...
//            }
            ...
            if (!TextUtils.isEmpty(mImageInfo.get(i).thumbnailUrl)) {
                getImageLoader().onDisplayImage(getContext(), childrenView, mImageInfo.get(i).getThumbnailUrl());
            } else {
                getImageLoader().onDisplayImage(getContext(), childrenView, mImageInfo.get(i).getBigImageUrl());
            }
