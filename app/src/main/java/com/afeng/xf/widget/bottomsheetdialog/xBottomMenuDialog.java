package com.afeng.xf.widget.bottomsheetdialog;
...
public class xBottomMenuDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public xBottomMenuDialog() {
    }

    @SuppressLint("ValidFragment")
    public xBottomMenuDialog(BottomMenuBuilder builder) {
        titles = builder.titles;
        listeners = builder.listeners;
        mStyleTheme = builder.mStyle_builder;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        if (mStyleTheme != -1) {
            dialog = new xBottomSheetDialog(getContext(), mStyleTheme);
        } else {
            dialog = new xBottomSheetDialog(getContext(), getTheme());
    ...
    public static class BottomMenuBuilder {
        ...
        public BottomMenuBuilder(@IdRes int styleTheme) {
            titles = new ArrayList<>();
            listeners = new HashMap<>();
            this.mStyle_builder = styleTheme;
        }

        public xBottomMenuDialog build() {
            if (titles == null || titles.isEmpty()) {

                Log.e(TAG, "can not empty titles");
            }

            return new xBottomMenuDialog(this);
        }
