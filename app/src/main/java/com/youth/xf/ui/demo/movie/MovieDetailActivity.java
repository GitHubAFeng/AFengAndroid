...
public class MovieDetailActivity extends AFengActivity {
    ...
    private void setupViewPager(ViewPager mViewPager) {
        MovieDetailActivity.MyPagerAdapter adapter = new MovieDetailActivity.MyPagerAdapter(getSupportFragmentManager());
        ...
        HttpClient.Builder.getDouBanService()
                ...
                .subscribe(new Observer<MovieDetailBean>() {
                    ...
                    public void onNext(MovieDetailBean movieDetailBean) {
                        ...
                        adapter.addFragment(MovieDetailFragment.newInstance(CastBuilder.toString()), "导演简介");
                        adapter.addFragment(MovieDetailFragment.newInstance(NameBuilder.toString()), "演员列表");
